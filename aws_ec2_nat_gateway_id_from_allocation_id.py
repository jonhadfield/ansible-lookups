...
"""
Description: This lookup takes an AWS region and an allocation id
and returns the associated NAT gateway id

Example Usage:
{{ lookup('aws_ec2_nat_gateway_id_from_allocation_id', ('eu-west-1', 'eipalloc-68b33333') }}
"""
...
try:
    ...
    raise AnsibleError("aws_ec2_nat_gateway_id_from_allocation_id lookup cannot be run without botocore and boto3 installed")

class LookupModule(LookupBase):

    def run(self, terms, variables=None, **kwargs):
        region = terms[0][0]
        allocation_id = terms[0][1]
