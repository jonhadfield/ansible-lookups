...
try:
    ...
    raise AnsibleError("aws_ec2_instance_public_ip_from_name lookup cannot be run without boto installed")
...
class LookupModule(LookupBase):
    ...
    def run(self, terms, variables=None, **kwargs):
        ...
        if ec2_instance and ec2_instance[0].ip_address:
            return [ec2_instance[0].ip_address.encode('utf-8')]
        return None